<template>
  <div class="">
    ...
    <!-- Start of Action -->
    <div class="flex flex-row items-center justify-around gap-1 my-2">
      <button class="border-gray-300 border-2 rounded-lg p-2">
        <div class="text-orange-300 w-16 h-16">
          <!-- bi:cone-striped -->
      ...
      <button class="border-gray-300 border-2 rounded-lg p-2">
        <!-- ion:cube -->
        <div class="text-purple-400 w-16 h-16">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M440.9 136.3a4 4 0 0 0 0-6.91L288.16 40.65a64.14 64.14 0 0 0-64.33 0L71.12 129.39a4 4 0 0 0 0 6.91L254 243.88a4 4 0 0 0 4.06 0ZM54 163.51a4 4 0 0 0-6 3.49v173.89a48 48 0 0 0 23.84 41.39L234 479.51a4 4 0 0 0 6-3.46V274.3a4 4 0 0 0-2-3.46ZM272 275v201a4 4 0 0 0 6 3.46l162.15-97.23A48 48 0 0 0 464 340.89V167a4 4 0 0 0-6-3.45l-184 108a4 4 0 0 0-2 3.45Z"/></svg>
        </div>
      </button>

      <button class="border-gray-300 border-2 rounded-lg p-2">
        <!-- material-symbols:ev-charger -->
        <div class="text-green-400 w-16 h-16">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="currentColor" d="m8.5 19l2.5-4H9.5v-3L7 16h1.5v3ZM6 10h6V5H6v5ZM4 21V5q0-.825.588-1.413T6 3h6q.825 0 1.413.588T14 5v7h1.25q.725 0 1.238.513T17 13.75v4.625q0 .425.35.775t.775.35q.45 0 .788-.35t.337-.775V9H19q-.425 0-.713-.288T18 8V6h.5V4.5h1V6h1V4.5h1V6h.5v2q0 .425-.288.713T21 9h-.25v9.375q0 1.05-.763 1.838T18.126 21q-1.075 0-1.85-.788t-.775-1.837V13.75q0-.125-.063-.188t-.187-.062H14V21H4Z"/></svg>
        </div>
      </button>

      <button class="border-gray-200 border-2 rounded-lg p-2">
        <!-- material-symbols:ev-charger -->
        <div class="text-red-400 w-16 h-16">
